...
sarkozy = Politic.create(name: "Sarkozy", country: "France", description: "Longue expérience en gestion de projet et évènementiel, expertise en financements de campagnes", picture: "https://cdn.radiofrance.fr/s3/cruiser-production/2017/01/c4314dc8-b0ca-4989-be12-0562125ba76f/838_kadhafi_et_nicolas_sarkozy_en_libye_juillet_2007_cpatrick_kovarik_afp.jpg", first_stupid: "Si t'as pas une Rollex à 50 ans, t'as raté ta vie", second_stupid: "Casse toi pauv' con", availability: true, rating: 4, user_id: usertest)
